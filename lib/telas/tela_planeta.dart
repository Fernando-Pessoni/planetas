                  ...
                  children: [
                    TextFormField(
                      ...
                      validator: (value) {
                        if (value == null ||
                            value.isEmpty ||
                            value.length < 3) {
                          return 'Nome não inserido ou caracteres insuficientes';
                        }
                        return null;
                      },
                      onSaved: (value) {
                    ...
                    TextFormField(
                      ...
                      validator: (value) {
                        if (value == null ||
                            value.isEmpty ||
                            value.length < 4) {
                          return 'Tamanho não inserido ou valor muito baixo';
                        }
                    ...
                    TextFormField(
                      ...
                      validator: (value) {
                        if (value == null ||
                            value.isEmpty ||
                            value.length < 4) {
                          return 'Distância não inserida ou valor muito baixo';
                        }
                        if (double.tryParse(value) == null) {
                          return 'Insira um valor numérico válido';
                        }
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: _submitFrom, //_submitForm,
